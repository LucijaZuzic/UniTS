...
for pair_best in find_all:
    ...
    filename = "mosaic_attention/Vehicle_" + vehicle + "_events_" + ride + "_" + model_name + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
    ...
    for model_name in predicted_long:
        for dist_name in predicted_long[model_name]:
            ...
            for v in set(int_veh):
                ...
                filename_veh = "mosaic_attention/Vehicle_" + str(v) + "_" + model_name + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
